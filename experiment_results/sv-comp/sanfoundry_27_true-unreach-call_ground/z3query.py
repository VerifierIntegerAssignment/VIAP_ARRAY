...
try:
	...
	_s.add(main == 0)
	_s.add(largest1 == largest3(_N1))
	_s.add(Not(Implies(ForAll([_n2],Implies(And(And(_n2>=0,_n2<_L2),_L2>0),((largest3(_L2))>=(d1array5(array,_n2,_n2))))),ForAll([_n2],Implies(And(And(And(And(_n2>=0,_n2<_L2),_L2>0),_n2<_L2+1),_L2>0),((largest3(_L2 + 1))>=(d1array5(array,_n2,_n2))))))))
