...
try:
	...
	a=Const('a',arraySort)
	rv3=Function('rv3',IntSort(),IntSort())
	b=Const('b',arraySort)
	i1=Int('i1')
	...
	_s.add(b1 == b)
	_s.add(i1 == _N1)
	_s.add(x1 == If(rv3(_N1) > 0,_N2,x))
	_s.add(rv1 == rv3(_N1))
	_s.add(ForAll([_x2,_x1],Implies(_x2>=0,d1array1(_x1,_x2) == If(rv3(_N1) > 0,d1array5(_x1,_x2,_N2),d1array(_x1,_x2)))))
	_s.add(main == 0)
	_s.add(ForAll([_n1],Implies(_n1>=0,rv3(_n1 + 1) == If(((d1array(a,_n1))!=(d1array(b,_n1))),0,rv3(_n1)))))
	_s.add(rv3(0) == 1)
	_s.add(_N1 >= 100000)
	...
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array5(b,_x2,0) == d1array(b,_x2))))
	_s.add(_N2 >= 100000)
	...
	_s.add(ForAll([_x2,_x1],Implies(_x2>=0,d1array1(_x1,_x2) == If(rv3(_N1) > 0,d1array5(_x1,_x2,_N2),d1array(_x1,_x2)))))
	_s.add(main == 0)
	_s.add(Not(Implies(ForAll([_n2],Implies(And(And(_n2>=0,_n2<_L2),_L2>0),Implies(rv3(_L2) > 0,(((d1array5(b,_n2,_n2)))==((d1array5(b,_n2,_n2))))))),ForAll([_n2],Implies(And(And(And(And(_n2>=0,_n2<_L2),_L2>0),_n2<_L2+1),_L2>0),Implies(And(rv3(_L2 + 1) > 0,_n2>=0),((d1array5(b,_n2,_n2))==(d1array5(b,_n2,_n2)))))))))
