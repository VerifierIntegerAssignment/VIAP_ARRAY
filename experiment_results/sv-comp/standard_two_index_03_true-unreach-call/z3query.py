...
try:
	...
	_s.add(_N1 >= 10000)
	_s.add(ForAll([_n1],Implies(And(_n1 < _N1,_n1>=0),_f(_n1) < 10000)))
	_s.add(Or(_N1==0,_N1 - 1 < 10000))
	_s.add(ForAll([_n2],Implies(_n2>=0,d1array5(a,_n2,_n2 + 1) == d1array5(b,3*_n2 + 1,_n2))))
	...
	_s.add(((_N2)>=(((((-1)/(3)))+(((10000)/(3)))))))
	_s.add(ForAll([_n2],Implies(And(_n2 < _N2,_n2>=0),3*_f(_n2) + 1 < 10000)))
	_s.add(Or(_N2==0,3*_N2 - 2 < 10000))
	...
	_s.add(((_N3)>=(((((-1)/(3)))+(((10000)/(3)))))))
	_s.add(ForAll([_n3],Implies(And(_n3 < _N3,_n3>=0),3*_f(_n3) + 1 < 10000)))
	_s.add(Or(_N3==0,3*_N3 - 2 < 10000))
	...
	_s.add(_N2>=0)
	_s.add(_N3>=0)
	_s.add(Not(ForAll([_n3],Implies(And(_n3<_N3,_n3>=0),((d1array8(a,_n3,_N3))==(d1array8(b,3*_n3 + 1,_N3)))))))
