...
try:
	...
	_s.add(Or(_N3 >= 100000,((d1array6(src,_N3,_N3))==(0))))
	_s.add(ForAll([_n3],Implies(And(_n3 < _N3,_n3>=0),And(_f(_n3) < 100000,((d1array6(src,_f(_n3),_f(_n3)))!=(0))))))
	_s.add(Or(_N3==0,And((_N3-1) < 100000,((d1array6(src,(_N3-1),(_N3-1)))!=(0)))))
