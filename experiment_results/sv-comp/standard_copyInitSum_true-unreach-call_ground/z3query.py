...
try:
	...
	_s.add(a1 == a)
	_s.add(b1 == b)
	_s.add(incr1 == __VERIFIER_nondet_int2)
	_s.add(i1 == _N3)
	...
	_s.add(ForAll([_n3],Implies(_n3>=0,d1array6(b,_n3,_n3 + 1) == ((d1array6(b,_n3,_n3))+(__VERIFIER_nondet_int2)))))
	...
	_s.add(ForAll([_n3],Implies(_n3>=0,d1array6(b,_n3,_N3) == ((42)+(__VERIFIER_nondet_int2)))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array8(a,_n1,_N4) == 42)))
	_s.add(ForAll([_n3],Implies(_n3>=0,d1array8(b,_n3,_N4) == ((42)+(__VERIFIER_nondet_int2)))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array2(b,_x2,_N1) == d1array(b,_x2))))
	...
	_s.add(_N3>=0)
	_s.add(_N4>=0)
	_s.add(Not(ForAll([_n4],Implies(And(_n4<_N4,_n4>=0),((d1array8(b,_n4,_N4))==(((42)+(__VERIFIER_nondet_int2))))))))
