...
try:
	...
	_s.add(i1 == _N4)
	_s.add(x1 == _N5)
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(b,_x2) == d1array10(b,_x2,_N5))))
	_s.add(main == 0)
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a,_x2) == d1array10(a,_x2,_N5))))
	...
	_s.add(ForAll([_n4],Implies(_n4>=0,d1array8(b,_n4,_n4 + 1) == ((d1array8(b,_n4,_n4))-(d1array8(a,_n4,_n4))))))
	...
	_s.add(ForAll([_n5,_x2],Implies(And(_n5>=0,_x2>=0),d1array10(a,_x2,_n5 + 1) == d1array10(a,_x2,_n5))))
	_s.add(ForAll([_n5,_x2],Implies(And(_n5>=0,_x2>=0),d1array10(b,_x2,_n5 + 1) == d1array10(b,_x2,_n5))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array10(a,_x2,0) == d1array8(a,_x2,_N4))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array10(b,_x2,0) == d1array8(b,_x2,_N4))))
	_s.add(_N5 >= 100000)
	...
	_s.add(ForAll([_n4,_n3],Implies(And(_n4>=0,_n3>=0),d1array8(b,_n4,_N4) == _n3)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array10(a,_n1,_N5) == 42)))
	_s.add(ForAll([_n4,_n3],Implies(And(_n4>=0,_n3>=0),d1array10(b,_n4,_N5) == _n3)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array2(b,_x2,_N1) == d1array(b,_x2))))
	...
	_s.add(_N4>=0)
	_s.add(_N5>=0)
	_s.add(Not(ForAll([_n5],Implies(And(_n5<_N5,_n5>=0),((d1array10(b,_n5,_N5))==(_n5))))))
