...
try:
	...
	_s.add(a1 == _N1)
	_s.add(i1 == _N3)
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a1_var,_x2) == d1array8(a1_var,_x2,_N4))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a3_var,_x2) == d1array8(a3_var,_x2,_N4))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a2_var,_x2) == d1array8(a2_var,_x2,_N4))))
	_s.add(main == 0)
	_s.add(x1 == _N4)
	...
	_s.add(_N3>=0)
	_s.add(_N4>=0)
	_s.add(Not(ForAll([_n4],Implies(And(_n4<_N4,_n4>=0),((d1array8(a1_var,_n4,_N4))==(d1array8(a3_var,_n4,_N4)))))))
