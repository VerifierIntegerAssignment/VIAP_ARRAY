...
try:
	...
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(b,_n1,_N1) == d1array(a,-_n1 + 99999))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array4(a,_x2,_N2) == d1array(a,_x2))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(b,_n1,_N2) == d1array(a,-_n1 + 99999))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array2(a,_x2,_N1) == d1array(a,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array2(a,_x2,_N1) == d1array2(a,_x2,_N1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(b,_n1,_N1) == d1array(a,-_n1 + 99999))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(b,_n1,_N1) == d1array2(a,-_n1 + 99999,_N1))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array4(a,_x2,_N2) == d1array(a,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array4(a,_x2,_N2) == d1array4(a,_x2,_N2))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(b,_n1,_N2) == d1array(a,-_n1 + 99999))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(b,_n1,_N2) == d1array4(a,-_n1 + 99999,_N2))))
	_s.add(a1 == a)
	_s.add(b1 == b)
	_s.add(_k1>=0)
	_s.add(_k2>=0)
	_s.add(_N1>=0)
	_s.add(_N2>=0)
	_s.add(Not(ForAll([_n2],Implies(And(_n2<_N2,_n2>=0),((d1array4(a,_n2,_N2))==(d1array4(b,-_n2 + 99999,_N2)))))))
