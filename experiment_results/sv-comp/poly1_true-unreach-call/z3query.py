...
try:
	...
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a,_x2) == If(((__VERIFIER_nondet_int2)>(1)),d1array4(a,_x2,_N2),d1array(a,_x2)))))
	_s.add(main == 1)
	_s.add(SIZE1 == __VERIFIER_nondet_int2)
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_n1 + 1) == _n1*_n1)))
	...
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == _n1*_n1)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(a,_n1,_N2) == _n1*_n1)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == _n1*_n1)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == _n1*_n1)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(a,_n1,_N2) == _n1*_n1)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(a,_n1,_N2) == _n1*_n1)))
	...
	_s.add(Not(ForAll([_n2],Implies(And(_n2<_N2,_n2>=0),Implies(((__VERIFIER_nondet_int2)>(1)),((d1array4(a,_n2,_N2))==(_n2*_n2)))))))
