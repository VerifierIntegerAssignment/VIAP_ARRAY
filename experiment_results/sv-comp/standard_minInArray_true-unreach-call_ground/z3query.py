...
try:
	...
	min3=Function('min3',IntSort(),IntSort())
	...
	_s.add(main == 0)
	_s.add(min1 == min3(_N1))
	_s.add(ForAll([_n1],Implies(_n1>=0,min3(_n1 + 1) == If(((d1array(a,_n1))<(min3(_n1))),d1array(a,_n1),min3(_n1)))))
	_s.add(min3(0) == 0)
	_s.add(_N1 >= 100000)
	...
	_s.add(main == 0)
	_s.add(min1 == min3(_N1))
	_s.add(Not(Implies(ForAll([_n2],Implies(And(And(_n2>=0,_n2<_L2),_L2>0),((d1array5(a,_n2,_n2))>=(min3(_L2))))),ForAll([_n2],Implies(And(And(And(And(_n2>=0,_n2<_L2),_L2>0),_n2<_L2+1),_L2>0),((d1array5(a,_n2,_n2))>=(min3(_L2 + 1))))))))
