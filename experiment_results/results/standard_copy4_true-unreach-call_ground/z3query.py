...
try:
	...
	_s.add(a1 == _N1)
	_s.add(i1 == _N5)
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a1_var,_x2) == d1array12(a1_var,_x2,_N6))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a5_var,_x2) == d1array12(a5_var,_x2,_N6))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a3_var,_x2) == d1array12(a3_var,_x2,_N6))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a2_var,_x2) == d1array12(a2_var,_x2,_N6))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a4_var,_x2) == d1array12(a4_var,_x2,_N6))))
	_s.add(main == 0)
	_s.add(x1 == _N6)
	...
	_s.add(_N5>=0)
	_s.add(_N6>=0)
	_s.add(Not(ForAll([_n6],Implies(And(_n6<_N6,_n6>=0),((d1array12(a1_var,_n6,_N6))==(d1array12(a5_var,_n6,_N6)))))))
