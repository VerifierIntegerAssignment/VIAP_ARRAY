...
try:
	...
	_s.add(x1 == _N7)
	_s.add(main == 0)
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a,_x2) == d1array14(a,_x2,_N7))))
	...
	_s.add(ForAll([_x2,_n7],Implies(And(_x2>=0,_n7>=0),d1array14(a,_x2,_n7 + 1) == d1array14(a,_x2,_n7))))
	...
	_s.add(ForAll([_n6],Implies(_n6>=0,d1array14(a,_n6,_N7) == 47)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_n2],Implies(_n2>=0,d1array4(a,_n2,_N2) == 43)))
	_s.add(ForAll([_n2],Implies(_n2>=0,d1array4(a,_n2,_N2) == 43)))
	...
	_s.add(_N6>=0)
	_s.add(_N7>=0)
	_s.add(Not(ForAll([_n7],Implies(And(_n7<_N7,_n7>=0),((d1array14(a,_n7,_N7))==(47))))))
