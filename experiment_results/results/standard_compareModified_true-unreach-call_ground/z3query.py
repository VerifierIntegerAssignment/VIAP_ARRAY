...
try:
	...
	_s.add(rv1 == rv4(_N1))
	_s.add(i1 == _N1)
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a,_x2) == d1array10(a,_x2,_N3))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(c,_x2) == d1array10(c,_x2,_N3))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(b,_x2) == d1array10(b,_x2,_N3))))
	_s.add(main == 0)
	_s.add(x1 == _N3)
	...
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(c,_n1,_N1) == d1array(a,_n1))))
	...
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array6(c,_n1,_N2) == d1array(a,_n1))))
	...
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array10(c,_n1,_N3) == d1array(a,_n1))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array10(b,_x2,_N3) == d1array(b,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array4(a,_x2,_N1) == d1array(a,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array4(a,_x2,_N1) == d1array4(a,_x2,_N1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(c,_n1,_N1) == d1array(a,_n1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array4(c,_n1,_N1) == d1array4(a,_n1,_N1))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array4(b,_x2,_N1) == d1array(b,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array4(b,_x2,_N1) == d1array4(b,_x2,_N1))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array6(a,_x2,_N2) == d1array(a,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array6(a,_x2,_N2) == d1array6(a,_x2,_N2))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array6(c,_n1,_N2) == d1array(a,_n1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array6(c,_n1,_N2) == d1array6(a,_n1,_N2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array6(b,_x2,_N2) == d1array(b,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array6(b,_x2,_N2) == d1array6(b,_x2,_N2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array10(a,_x2,_N3) == d1array(a,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array10(a,_x2,_N3) == d1array10(a,_x2,_N3))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array10(c,_n1,_N3) == d1array(a,_n1))))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array10(c,_n1,_N3) == d1array10(a,_n1,_N3))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array10(b,_x2,_N3) == d1array(b,_x2))))
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array10(b,_x2,_N3) == d1array10(b,_x2,_N3))))
	_s.add(a1 == a)
	_s.add(c1 == c)
	_s.add(b1 == b)
	_s.add(_k1>=0)
	...
	_s.add(_N2>=0)
	_s.add(_N3>=0)
	_s.add(Not(ForAll([_n3],Implies(And(_n3<_N3,_n3>=0),((d1array10(a,_n3,_N3))==(d1array10(c,_n3,_N3)))))))
