...
try:
	...
	_s.add(x1 == _N9)
	_s.add(main == 0)
	_s.add(ForAll([_x2],Implies(_x2>=0,d1array1(a,_x2) == d1array18(a,_x2,_N9))))
	...
	_s.add(ForAll([_x2,_n9],Implies(And(_x2>=0,_n9>=0),d1array18(a,_x2,_n9 + 1) == d1array18(a,_x2,_n9))))
	...
	_s.add(ForAll([_n8],Implies(_n8>=0,d1array18(a,_n8,_N9) == 49)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_n1],Implies(_n1>=0,d1array2(a,_n1,_N1) == 42)))
	_s.add(ForAll([_n2],Implies(_n2>=0,d1array4(a,_n2,_N2) == 43)))
	_s.add(ForAll([_n2],Implies(_n2>=0,d1array4(a,_n2,_N2) == 43)))
	...
	_s.add(_N8>=0)
	_s.add(_N9>=0)
	_s.add(Not(ForAll([_n9],Implies(And(_n9<_N9,_n9>=0),((d1array18(a,_n9,_N9))==(49))))))
