...
try:
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array2(A,_n3,_n2,_n1,_N1(_n2,_n3),_n2,_n3) == d3array(A,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array9(A,_n3,_n2,_n1,_N3) == d3array(A,_n3,_n2,_n1))))
	_s.add(ForAll([_x3,_x2,_x4],Implies(And(_x3>=0,And(_x2>=0,_x4>=0)),d3array9(B,_x2,_x3,_x4,_N3) == d3array(B,_x2,_x3,_x4))))
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array5(A,_n3,_n2,_n1,_N2(_n3),_n3) == d3array(A,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n5,_n6,_n1,_n3,_n2],Implies(And(_n5>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),d3array11(A,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6) == d3array(A,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array18(A,_n3,_n2,_n1,_N6) == d3array(A,_n3,_n2,_n1))))
	_s.add(ForAll([_x3,_x2,_x4],Implies(And(_x3>=0,And(_x2>=0,_x4>=0)),d3array18(B,_x2,_x3,_x4,_N6) == d3array(B,_x2,_x3,_x4))))
	_s.add(ForAll([_n6,_n1,_n3,_n2],Implies(And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d3array14(A,_n3,_n2,_n1,_N5(_n6),_n6) == d3array(A,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n5,_n6,_n1,_n3,_n2],Implies(And(_n5>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),d3array11(A,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6) == d3array(A,_n3,_n2,_n1))))
	_s.add(ForAll([_n5,_n6,_n1,_n3,_n2],Implies(And(_n5>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),d3array11(A,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6) == d3array11(A,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6))))
	_s.add(ForAll([_x3,_x2,_n6,_n5,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_n6>=0,And(_n5>=0,_x4>=0)))),d3array11(B,_x2,_x3,_x4,_N4(_n5,_n6),_n5,_n6) == d3array(B,_x2,_x3,_x4))))
	...
	_s.add(_N6>=0)
	_s.add(p < n)
	_s.add(Not(ForAll([_n5,_n4,_n6],Implies(And(_n5<_N5(_n6),And(_n4<_N4(_n5, _n6),And(_n6<_N6,And(_n5>=0,And(_n4>=0,_n6>=0))))),((d3array18(A,_n6,_n5,_n4,_N6))==(d3array18(A,_n6,_n5,_n4,_N6)))))))
