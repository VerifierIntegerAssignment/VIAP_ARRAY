...
try:
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array2(A,_n4,_n3,_n2,_n1,_n1 + 1,_n2,_n3,_n4) == d4array2(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_n1,_n2,_n3,_n4))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array2(A,_n4,_n3,_n2,_n1,_N1(_n2,_n3,_n4),_n2,_n3,_n4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array14(A,_n4,_n3,_n2,_n1,_N4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array9(A,_n4,_n3,_n2,_n1,_N3(_n4),_n4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array5(A,_n4,_n3,_n2,_n1,_N2(_n3,_n4),_n3,_n4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n7,_n6,_n1,_n3,_n2,_n8],Implies(And(_n4>=0,And(_n7>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,And(_n2>=0,_n8>=0)))))),d4array16(A,_n4,_n3,_n2,_n1,_N5(_n6,_n7,_n8),_n6,_n7,_n8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array28(A,_n4,_n3,_n2,_n1,_N8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n1,_n8,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n8>=0,And(_n3>=0,_n2>=0)))),d4array23(A,_n4,_n3,_n2,_n1,_N7(_n8),_n8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n7,_n1,_n3,_n2,_n8],Implies(And(_n4>=0,And(_n7>=0,And(_n1>=0,And(_n3>=0,And(_n2>=0,_n8>=0))))),d4array19(A,_n4,_n3,_n2,_n1,_N6(_n7,_n8),_n7,_n8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array2(A,_n4,_n3,_n2,_n1,_N1(_n2,_n3,_n4),_n2,_n3,_n4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array2(A,_n4,_n3,_n2,_n1,_N1(_n2,_n3,_n4),_n2,_n3,_n4) == d4array2(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_N1(_n2,_n3,_n4),_n2,_n3,_n4))))
	_s.add(ForAll([_x3,_x2,_x5,_x4,_n4,_n3,_n2],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,And(_x4>=0,And(_n4>=0,And(_n3>=0,_n2>=0)))))),d4array2(B,_x2,_x3,_x4,_x5,_N1(_n2,_n3,_n4),_n2,_n3,_n4) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array14(A,_n4,_n3,_n2,_n1,_N4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array14(A,_n4,_n3,_n2,_n1,_N4) == d4array14(A,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_n4 + 1))))
	_s.add(ForAll([_x3,_x2,_x5,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,_x4>=0))),d4array14(B,_x2,_x3,_x4,_x5,_N4) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array9(A,_n4,_n3,_n2,_n1,_N3(_n4),_n4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array9(A,_n4,_n3,_n2,_n1,_N3(_n4),_n4) == d4array9(A,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_n3 + 1,_n4))))
	_s.add(ForAll([_x3,_x2,_n4,_x5,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_n4>=0,And(_x5>=0,_x4>=0)))),d4array9(B,_x2,_x3,_x4,_x5,_N3(_n4),_n4) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array5(A,_n4,_n3,_n2,_n1,_N2(_n3,_n4),_n3,_n4) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array5(A,_n4,_n3,_n2,_n1,_N2(_n3,_n4),_n3,_n4) == d4array5(A,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_n2 + 1,_n3,_n4))))
	_s.add(ForAll([_x3,_x2,_x5,_x4,_n4,_n3],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,And(_x4>=0,And(_n4>=0,_n3>=0))))),d4array5(B,_x2,_x3,_x4,_x5,_N2(_n3,_n4),_n3,_n4) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(ForAll([_n4,_n7,_n6,_n1,_n3,_n2,_n8],Implies(And(_n4>=0,And(_n7>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,And(_n2>=0,_n8>=0)))))),d4array16(A,_n4,_n3,_n2,_n1,_N5(_n6,_n7,_n8),_n6,_n7,_n8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n7,_n6,_n1,_n3,_n2,_n8],Implies(And(_n4>=0,And(_n7>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,And(_n2>=0,_n8>=0)))))),d4array16(A,_n4,_n3,_n2,_n1,_N5(_n6,_n7,_n8),_n6,_n7,_n8) == d4array16(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_N5(_n6,_n7,_n8),_n6,_n7,_n8))))
	_s.add(ForAll([_x3,_x2,_x5,_x4,_n7,_n6,_n8],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,And(_x4>=0,And(_n7>=0,And(_n6>=0,_n8>=0)))))),d4array16(B,_x2,_x3,_x4,_x5,_N5(_n6,_n7,_n8),_n6,_n7,_n8) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(ForAll([_n4,_n1,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d4array28(A,_n4,_n3,_n2,_n1,_N8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n1,_n8,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n8>=0,And(_n3>=0,_n2>=0)))),d4array28(A,_n4,_n3,_n2,_n1,_N8) == d4array28(A,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_n8 + 1))))
	_s.add(ForAll([_x3,_x2,_x5,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,_x4>=0))),d4array28(B,_x2,_x3,_x4,_x5,_N8) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(ForAll([_n4,_n1,_n8,_n3,_n2],Implies(And(_n4>=0,And(_n1>=0,And(_n8>=0,And(_n3>=0,_n2>=0)))),d4array23(A,_n4,_n3,_n2,_n1,_N7(_n8),_n8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n7,_n1,_n3,_n2,_n8],Implies(And(_n4>=0,And(_n7>=0,And(_n1>=0,And(_n3>=0,And(_n2>=0,_n8>=0))))),d4array23(A,_n4,_n3,_n2,_n1,_N7(_n8),_n8) == d4array23(A,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_n7 + 1,_n8))))
	_s.add(ForAll([_x3,_x2,_n8,_x5,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_n8>=0,And(_x5>=0,_x4>=0)))),d4array23(B,_x2,_x3,_x4,_x5,_N7(_n8),_n8) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(ForAll([_n4,_n7,_n1,_n3,_n2,_n8],Implies(And(_n4>=0,And(_n7>=0,And(_n1>=0,And(_n3>=0,And(_n2>=0,_n8>=0))))),d4array19(A,_n4,_n3,_n2,_n1,_N6(_n7,_n8),_n7,_n8) == d4array(B,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1))))
	_s.add(ForAll([_n4,_n7,_n6,_n1,_n3,_n2,_n8],Implies(And(_n4>=0,And(_n7>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,And(_n2>=0,_n8>=0)))))),d4array19(A,_n4,_n3,_n2,_n1,_N6(_n7,_n8),_n7,_n8) == d4array19(A,-_n4 + m - 1,-_n3 + n - 1,-_n2 + p - 1,-_n1 + q - 1,_n6 + 1,_n7,_n8))))
	_s.add(ForAll([_x3,_x2,_x5,_x4,_n7,_n8],Implies(And(_x3>=0,And(_x2>=0,And(_x5>=0,And(_x4>=0,And(_n7>=0,_n8>=0))))),d4array19(B,_x2,_x3,_x4,_x5,_N6(_n7,_n8),_n7,_n8) == d4array(B,_x2,_x3,_x4,_x5))))
	...
	_s.add(_N8>=0)
	_s.add(Not(ForAll([_n5,_n7,_n6,_n8],Implies(And(_n5<_N5(_n6, _n7, _n8),And(_n7<_N7(_n8),And(_n6<_N6(_n7, _n8),And(_n8<_N8,And(_n5>=0,And(_n7>=0,And(_n6>=0,_n8>=0))))))),((d4array28(A,_n8,_n7,_n6,_n5,_N8))==(d4array28(B,-_n8 + m - 1,-_n7 + n - 1,-_n6 + p - 1,-_n5 + q - 1,_N8)))))))
