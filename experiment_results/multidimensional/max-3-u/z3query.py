...
try:
	...
	_n2=Int('_n2')
	max3=Function('max3',IntSort(),IntSort(),IntSort())
	_n1=Int('_n1')
	max6=Function('max6',IntSort(),IntSort())
	_n4=Int('_n4')
	n=Int('n')
	_n3=Int('_n3')
	n1=Int('n1')
	...
	_s.add(n1 == n)
	_s.add(i1 == _N4)
	_s.add(max1 == max6(_N2))
	_s.add(j1 == j11(_N4))
	_s.add(ForAll([_x3,_x2,_x1],Implies(And(_x3>=0,_x2>=0),d2array1(_x1,_x2,_x3) == d2array11(_x1,_x2,_x3,_N4))))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),max3(_n1 + 1, _n2) == If(((d2array(A,_n2,_n1))>(max3(_n1, _n2))),d2array(A,_n2,_n1),max3(_n1, _n2)))))
	_s.add(ForAll([_n2],max3(0, _n2) == max6(_n2)))
	...
	_s.add(ForAll([_n2],Implies(_n2>=0,max6(_n2 + 1) == max3(_N1(_n2), _n2))))
	_s.add(ForAll([_n2],Implies(_n2>=0,j6(_n2 + 1) == _N1(_n2))))
	_s.add(max6(0) == d2array(A,0,0))
	_s.add(j6(0) == 0)
	_s.add(_N2 >= n)
	...
	_s.add(ForAll([_n4,_n3],Implies(And(_n4>=0,_n3>=0),((d2array(A,_n4,_n3))<=(max6(_L4))))))
	_s.add(_L4 >= 0)
	_s.add(A1 == A)
	_s.add(m1 == m)
	_s.add(n1 == n)
	...
	_s.add(j1 == j11(_N4))
	_s.add(ForAll([_x3,_x2,_x1],Implies(And(_x3>=0,_x2>=0),d2array1(_x1,_x2,_x3) == d2array11(_x1,_x2,_x3,_N4))))
	_s.add(Not(Implies(ForAll([_n4,_n3],Implies(And(And(And(_n4>=0,_n3>=0),_n3<_L3),_L3>0),((d2array(A,_n4,_n3))<=(max3(_L3, _L4))))),ForAll([_n4,_n3],Implies(And(And(And(And(And(_n4>=0,_n3>=0),_n3<_L3),_L3>0),_n3<_L3+1),_L3>0),((d2array(A,_n4,_n3))<=(max3(_L3 + 1, _L4))))))))
