...
try:
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array2(A,_n3,_n2,_n1,_n1 + 1,_n2,_n3) == d3array2(B,_n3,_n2,_n1,_n1,_n2,_n3))))
	...
	_s.add(ForAll([_n3,_n2],Implies(And(_n3>=0,_n2>=0),_N1(_n2, _n3) >= t)))
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1 < _N1(_n2, _n3),And(_n1>=0,And(_n3>=0,_n2>=0))),_f(_n1) < t)))
	_s.add(ForAll([_n3,_n2],Implies(And(_n3>=0,_n2>=0),Or(_N1(_n2, _n3)==0,_N1(_n2, _n3) - 1 < t))))
	...
	_s.add(ForAll([_n3],Implies(_n3>=0,_N2(_n3) >= s)))
	_s.add(ForAll([_n3,_n2],Implies(And(_n2 < _N2(_n3),And(_n3>=0,_n2>=0)),_f(_n2) < s)))
	_s.add(ForAll([_n3],Implies(_n3>=0,Or(_N2(_n3)==0,_N2(_n3) - 1 < s))))
	...
	_s.add(_N3 >= q)
	_s.add(ForAll([_n3],Implies(And(_n3 < _N3,_n3>=0),_f(_n3) < q)))
	_s.add(Or(_N3==0,_N3 - 1 < q))
	...
	_s.add(ForAll([_n5,_n6],Implies(And(_n5>=0,_n6>=0),_N4(_n5, _n6) >= t)))
	_s.add(ForAll([_n5,_n4,_n6],Implies(And(_n4 < _N4(_n5, _n6),And(_n5>=0,And(_n4>=0,_n6>=0))),_f(_n4) < t)))
	_s.add(ForAll([_n5,_n6],Implies(And(_n5>=0,_n6>=0),Or(_N4(_n5, _n6)==0,_N4(_n5, _n6) - 1 < t))))
	...
	_s.add(ForAll([_n6],Implies(_n6>=0,_N5(_n6) >= s)))
	_s.add(ForAll([_n5,_n6],Implies(And(_n5 < _N5(_n6),And(_n5>=0,_n6>=0)),_f(_n5) < s)))
	_s.add(ForAll([_n6],Implies(_n6>=0,Or(_N5(_n6)==0,_N5(_n6) - 1 < s))))
	...
	_s.add(_N6 >= q)
	_s.add(ForAll([_n6],Implies(And(_n6 < _N6,_n6>=0),_f(_n6) < q)))
	_s.add(Or(_N6==0,_N6 - 1 < q))
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array2(A,_n3,_n2,_n1,_N1(_n2,_n3),_n2,_n3) == d3array(B,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array9(A,_n3,_n2,_n1,_N3) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_x3,_x2,_x4],Implies(And(_x3>=0,And(_x2>=0,_x4>=0)),d3array9(B,_x2,_x3,_x4,_N3) == d3array(B,_x2,_x3,_x4))))
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array5(A,_n3,_n2,_n1,_N2(_n3),_n3) == d3array(B,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n5,_n6,_n1,_n3,_n2],Implies(And(_n5>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),d3array11(A,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6) == d3array(B,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array18(A,_n3,_n2,_n1,_N6) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_x3,_x2,_x4],Implies(And(_x3>=0,And(_x2>=0,_x4>=0)),d3array18(B,_x2,_x3,_x4,_N6) == d3array(B,_x2,_x3,_x4))))
	_s.add(ForAll([_n6,_n1,_n3,_n2],Implies(And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d3array14(A,_n3,_n2,_n1,_N5(_n6),_n6) == d3array(B,_n3,_n2,_n1))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array2(A,_n3,_n2,_n1,_N1(_n2,_n3),_n2,_n3) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array2(A,_n3,_n2,_n1,_N1(_n2,_n3),_n2,_n3) == d3array2(B,_n3,_n2,_n1,_N1(_n2,_n3),_n2,_n3))))
	_s.add(ForAll([_x3,_x2,_n3,_n2,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_n3>=0,And(_n2>=0,_x4>=0)))),d3array2(B,_x2,_x3,_x4,_N1(_n2,_n3),_n2,_n3) == d3array(B,_x2,_x3,_x4))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array9(A,_n3,_n2,_n1,_N3) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array9(A,_n3,_n2,_n1,_N3) == d3array9(A,_n3,_n2,_n1,_n3 + 1))))
	_s.add(ForAll([_x3,_x2,_x4],Implies(And(_x3>=0,And(_x2>=0,_x4>=0)),d3array9(B,_x2,_x3,_x4,_N3) == d3array(B,_x2,_x3,_x4))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array5(A,_n3,_n2,_n1,_N2(_n3),_n3) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array5(A,_n3,_n2,_n1,_N2(_n3),_n3) == d3array5(A,_n3,_n2,_n1,_n2 + 1,_n3))))
	_s.add(ForAll([_x3,_x2,_n3,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_n3>=0,_x4>=0))),d3array5(B,_x2,_x3,_x4,_N2(_n3),_n3) == d3array(B,_x2,_x3,_x4))))
	...
	_s.add(ForAll([_n5,_n6,_n1,_n3,_n2],Implies(And(_n5>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),d3array11(A,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_n5,_n6,_n1,_n3,_n2],Implies(And(_n5>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),d3array11(A,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6) == d3array11(B,_n3,_n2,_n1,_N4(_n5,_n6),_n5,_n6))))
	_s.add(ForAll([_x3,_x2,_n6,_n5,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_n6>=0,And(_n5>=0,_x4>=0)))),d3array11(B,_x2,_x3,_x4,_N4(_n5,_n6),_n5,_n6) == d3array(B,_x2,_x3,_x4))))
	...
	_s.add(ForAll([_n1,_n3,_n2],Implies(And(_n1>=0,And(_n3>=0,_n2>=0)),d3array18(A,_n3,_n2,_n1,_N6) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_n6,_n1,_n3,_n2],Implies(And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d3array18(A,_n3,_n2,_n1,_N6) == d3array18(A,_n3,_n2,_n1,_n6 + 1))))
	_s.add(ForAll([_x3,_x2,_x4],Implies(And(_x3>=0,And(_x2>=0,_x4>=0)),d3array18(B,_x2,_x3,_x4,_N6) == d3array(B,_x2,_x3,_x4))))
	...
	_s.add(ForAll([_n6,_n1,_n3,_n2],Implies(And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0))),d3array14(A,_n3,_n2,_n1,_N5(_n6),_n6) == d3array(B,_n3,_n2,_n1))))
	_s.add(ForAll([_n5,_n6,_n1,_n3,_n2],Implies(And(_n5>=0,And(_n6>=0,And(_n1>=0,And(_n3>=0,_n2>=0)))),d3array14(A,_n3,_n2,_n1,_N5(_n6),_n6) == d3array14(A,_n3,_n2,_n1,_n5 + 1,_n6))))
	_s.add(ForAll([_x3,_x2,_n6,_x4],Implies(And(_x3>=0,And(_x2>=0,And(_n6>=0,_x4>=0))),d3array14(B,_x2,_x3,_x4,_N5(_n6),_n6) == d3array(B,_x2,_x3,_x4))))
	...
	_s.add(t < p)
	_s.add(q < m)
	_s.add(Not(ForAll([_n5,_n4,_n6],Implies(And(_n5<_N5(_n6),And(_n4<_N4(_n5, _n6),And(_n6<_N6,And(_n5>=0,And(_n4>=0,_n6>=0))))),((d3array18(A,_n6,_n5,_n4,_N6))==(d3array18(B,_n6,_n5,_n4,_N6)))))))
