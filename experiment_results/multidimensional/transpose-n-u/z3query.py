...
try:
	...
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array2(C,_n1,_n2,_n1 + 1,_n2) == d2array2(A,_n2,_n1,_n1,_n2))))
	...
	_s.add(ForAll([_n2],Implies(_n2>=0,_N1(_n2) >= m)))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1 < _N1(_n2),And(_n1>=0,_n2>=0)),_f(_n1) < m)))
	_s.add(ForAll([_n2],Implies(_n2>=0,Or(_N1(_n2)==0,_N1(_n2) - 1 < m))))
	...
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array2(C,_n1,_n2,_N1(_n2),_n2) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_x3,_x2],Implies(And(_x3>=0,_x2>=0),d2array5(A,_x2,_x3,_N2) == d2array(A,_x2,_x3))))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array5(C,_n1,_n2,_N2) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_x3,_x2,_n4],Implies(And(_x3>=0,And(_x2>=0,_n4>=0)),d2array7(A,_x2,_x3,_N3(_n4),_n4) == d2array(A,_x2,_x3))))
	_s.add(ForAll([_n4,_n1,_n2],Implies(And(_n4>=0,And(_n1>=0,_n2>=0)),d2array7(C,_n1,_n2,_N3(_n4),_n4) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_x3,_x2],Implies(And(_x3>=0,_x2>=0),d2array10(A,_x2,_x3,_N4) == d2array(A,_x2,_x3))))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array10(C,_n1,_n2,_N4) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_x3,_x2,_n2],Implies(And(_x3>=0,And(_x2>=0,_n2>=0)),d2array2(A,_x2,_x3,_N1(_n2),_n2) == d2array(A,_x2,_x3))))
	...
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array2(C,_n1,_n2,_N1(_n2),_n2) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array2(C,_n1,_n2,_N1(_n2),_n2) == d2array2(A,_n2,_n1,_N1(_n2),_n2))))
	_s.add(ForAll([_x3,_x2],Implies(And(_x3>=0,_x2>=0),d2array5(A,_x2,_x3,_N2) == d2array(A,_x2,_x3))))
	_s.add(ForAll([_x3,_x2,_n2],Implies(And(_x3>=0,And(_x2>=0,_n2>=0)),d2array5(A,_x2,_x3,_N2) == d2array5(A,_x2,_x3,_n2 + 1))))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array5(C,_n1,_n2,_N2) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array5(C,_n1,_n2,_N2) == d2array5(C,_n2,_n1,_n2 + 1))))
	_s.add(ForAll([_x3,_x2,_n4],Implies(And(_x3>=0,And(_x2>=0,_n4>=0)),d2array7(A,_x2,_x3,_N3(_n4),_n4) == d2array(A,_x2,_x3))))
	...
	_s.add(ForAll([_n4,_n1,_n2],Implies(And(_n4>=0,And(_n1>=0,_n2>=0)),d2array7(C,_n1,_n2,_N3(_n4),_n4) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_n4,_n1,_n2],Implies(And(_n4>=0,And(_n1>=0,_n2>=0)),d2array7(C,_n1,_n2,_N3(_n4),_n4) == d2array7(A,_n2,_n1,_N3(_n4),_n4))))
	_s.add(ForAll([_x3,_x2],Implies(And(_x3>=0,_x2>=0),d2array10(A,_x2,_x3,_N4) == d2array(A,_x2,_x3))))
	_s.add(ForAll([_x3,_x2,_n4],Implies(And(_x3>=0,And(_x2>=0,_n4>=0)),d2array10(A,_x2,_x3,_N4) == d2array10(A,_x2,_x3,_n4 + 1))))
	_s.add(ForAll([_n1,_n2],Implies(And(_n1>=0,_n2>=0),d2array10(C,_n1,_n2,_N4) == d2array(A,_n2,_n1))))
	_s.add(ForAll([_n4,_n1,_n2],Implies(And(_n4>=0,And(_n1>=0,_n2>=0)),d2array10(C,_n1,_n2,_N4) == d2array10(C,_n2,_n1,_n4 + 1))))
	_s.add(A1 == A)
	_s.add(C1 == C)
	_s.add(m1 == m)
	_s.add(k1 == k)
	...
	_s.add(_N4>=0)
	_s.add(Not(ForAll([_n4,_n3],Implies(And(_n4<_N4,And(_n3<_N3(_n4),And(_n4>=0,_n3>=0))),((d2array10(C,_n4,_n3,_N4))==(d2array10(A,_n4,_n3,_N4)))))))
